...
export const metadata: Metadata = {
  title: 'Portfolio Développeur Front end React | Next.js | Node.js | SEO Matteo Chante-Biyikli',
  description: 'Salut ! Je suis Matteo, Développeur Front end React Next js. Je suis prêt à entendre dans votre projet, venez voir mon portfolio !',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="fr">
      <body className={`relative ${inter.className} bg-gray-50 text-gray-950`}>
